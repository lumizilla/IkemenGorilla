...
protocol VotedAnimalDetailHeaderDelegate {
    func didTapAnimal() -> Void
    func didTapZoo() -> Void
}

final class VotedAnimalDetailHeader: UIView, View, ViewConstructor {
    struct Const {
    ...
    var delegate: VotedAnimalDetailHeaderDelegate?
