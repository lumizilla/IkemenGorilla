//
//  ProfileCurrentContestListView.swift
//  Gorilla
//
...
final class ProfileCurrentContestListView: UICollectionView, View, ViewConstructor {
    ...
    struct Reusable {
        static let contestListCell = ReusableCell<ProfileCurrentContestListCell>()
    }
    ...
    // MARK: - Bind Method
    func bind(reactor: ProfileCurrentContestListReactor) {
        // Action
