//
//  ProfileVotedContestListView.swift
//  Gorilla
//
...
final class ProfileVotedContestListView: UICollectionView, View, ViewConstructor {
    ...
    struct Reusable {
        static let contestListCell = ReusableCell<ProfileVotedContestListCell>()
    }
    ...
    // MARK: - Bind Method
    func bind(reactor: ProfileVotedContestListReactor) {
        // Action
