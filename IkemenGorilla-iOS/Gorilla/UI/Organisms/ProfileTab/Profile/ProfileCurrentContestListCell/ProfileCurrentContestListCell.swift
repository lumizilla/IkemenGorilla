//
//  ProfileCurrentContestListCell.swift
//  Gorilla
//
...
final class ProfileCurrentContestListCell: UICollectionViewCell, View, ViewConstructor {
    ...
    // MARK: - Bind Method
    func bind(reactor: ProfileCurrentContestListCellReactor) {
        // Action
