...
final class ProfileLikedZooListCell: UICollectionViewCell, View, ViewConstructor {
    ...
    // MARK: - Bind Method
    func bind(reactor: ProfileLikedZooListCellReactor) {
        // Action
