//
//  ProfileContestDetailResultVoteCell.swift
//  Gorilla
//
...
final class ProfileContestDetailResultVoteCell: UICollectionViewCell, View, ViewConstructor {
    ...
    // MARK: - Bind Method
    func bind(reactor: ProfileContestDetailResultVoteCellReactor) {
        // Action
