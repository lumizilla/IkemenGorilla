//
//  AnimalDetailPastContestCell.swift
//  Gorilla
//
...
final class AnimalDetailPastContestCell: UICollectionViewCell, View, ViewConstructor {
    struct Const {
    ...
    // MARK: - Bind Method
    func bind(reactor: AnimalDetailPastContestCellReactor) {
        // Action
