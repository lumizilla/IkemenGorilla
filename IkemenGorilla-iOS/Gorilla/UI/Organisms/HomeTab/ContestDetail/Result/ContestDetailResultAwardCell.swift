//
//  ContestDetailResultAwardCell.swift
//  Gorilla
//
...
final class ContestDetailResultAwardCell: UICollectionViewCell, View, ViewConstructor {
    ...
    // MARK: - Bind Method
    func bind(reactor: ContestDetailResultAwardCellReactor) {
        // Action
