//
//  ProfileContestDetailPostViewController.swift
//  Gorilla
//
...
final class ProfileContestDetailPostViewController: UIViewController, View, ViewConstructor, SegementSlideContentScrollViewDelegate, TransitionPresentable {
    
    struct Reusable {
        static let postCell = ReusableCell<ProfileContestDetailPostCell>()
    }
    ...
    // MARK: - Bind Method
    func bind(reactor: ProfileContestDetailPostReactor) {
        // Action
